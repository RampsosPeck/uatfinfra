...
<div class="container ">
    <div class="box box-info " style="background-color: #E5F2FF;">
        <div class="box-header">
            <center><h3 class="box-title"><b><FONT COLOR="#3c8dbc">LISTA DE SOLICITUDES DE TRABAJO DE LA SECCIÓN JARDINERÍA</FONT></b></h3></center>
            
            @include('servicios.jardineria.create')
            
             <button class="btn btn-primary pull-right" data-toggle="modal" data-target="#modalJar"><i class="fa fa-plus"></i> Crear SOLICITUD</button>
   			...
   			<table id="carpinteria-table" class="table table-bordered table-striped ">
 				...
 				<tbody bgcolor="#d9edf7" >
                    ...
                    <tr>
                        ...
                        <?php $material = Devolucion::where('sol_id',$general->id)->where('seccion','jardinería')->count(); ?>
