<div class="modal fade" id="modalObservar{{ $general->id }}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="login-box-body" >
      <div class="modal-header" >
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>  
        <h4 class="modal-title text-center"   style="color:yellow" id="modalObservar"><b>INSERTAR NOTA DE OBSERVACIÓN</b></h4>
      ...
      <div class="modal-body" > 
          ...
          <div class="form-group {{ $errors->has('comentario') ? 'has-error' : '' }}">
            ...
            {!! Form::textarea('comentario',old('comentario',$general->comentario),['class'=>'form-control', 'rows'=>'2','placeholder'=>'Insertar alguna NOTA sobre la aprobación del trabajo Ejm. El trabajo se realizará cuando se obtenga los materiales.']) !!}
