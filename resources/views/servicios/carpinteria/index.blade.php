 				...
 				<tbody bgcolor="#d9edf7" >
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                             {!!link_to_route('generales.edit', $title = ' Editar', $parameters = $general->id, $attributes = ['class'=>'btn btn-primary btn-xs  fa fa-pencil-square-o', 'data-toggle'=>'tooltip', 'data-placement'=>'left', 'title'=>' Editar la solicitud de trabajo.'])!!}
                        ...
                        <?php $material = Devolucion::where('sol_id',$general->id)->where('seccion','carpintería')->count(); ?>
