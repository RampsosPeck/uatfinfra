<ul class="sidebar-menu">
    ...
    <li class="treeview {{ request()->is('travels*') ? 'active' : '' }}">
        ...
        <ul class="treeview-menu">
          <li {{ request()->is('travels') ? 'class=active' : '' }}><a href="{!! URL::to('/travels') !!}"><i class="fa fa-calendar"></i> <b>Calendario de Viajes</b></a></li>
          <li {{ request()->is('travels') ? 'class=active' : '' }}><a href="{!! URL::to('/travels/create') !!}"><i class="fa fa-rol"></i> <b>Rol de Viajes</b></a></li>
