<h1>
  ...
  <ol class="breadcrumb">
    ...
    <li><a href="{!! URL::to('/informes') !!}" class="btn btn-sm btn-danger" data-toggle="tooltip" data-placement="bottom" title="Listar los informes" ><i class="fa fa-exclamation-circle"></i>&nbsp; <b>Informes</b></a></li>
